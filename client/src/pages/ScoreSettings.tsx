...
import { collaboratorsApi, scoresApi } from '@/api';
          ...
          {isOwner && (
            <div className={styles.inviteForm}>
              ...
              <div className={styles.inviteRow}>
                ...
                <Button variant="primary" size="sm" onClick={handleInvite} disabled={!inviteUserId}>邀请</Button>
              </div>
            </div>
          )}
        </div>
            ...
            <div className={styles.transferSection}>
              ...
              <div className={styles.inviteRow}>
                <select className={styles.select} value={newOwnerId} onChange={(e) => setNewOwnerId(e.target.value)}>
                  ...
                  {usersAPI.list.data.filter((u) => u.id !== score.owner_id).map((u) => (
